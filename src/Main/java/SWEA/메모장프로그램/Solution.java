...
public class Solution {
    ...
    private final static SWEA.메모장프로그램.UserSolution usersolution = new SWEA.메모장프로그램.UserSolution();
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.setIn(new java.io.FileInputStream("src/Main/java/SWEA/알고리즘특강/메모장프로그램/sample_input.txt"));
