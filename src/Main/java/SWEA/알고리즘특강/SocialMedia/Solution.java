...
//                if (!ret) {
//                    System.out.println("ans_pIdList: " + Arrays.toString(ans_pIdList));
//                    System.out.println("pIdList: " + Arrays.toString(pIdList));
//                }
            }
        }
    ...
    public static void main(String[] args) throws Exception {
		System.setIn(new java.io.FileInputStream("src/Main/java/SWEA/알고리즘특강/SocialMedia/sample_sample_input.txt"));
